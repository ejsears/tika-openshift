...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install $JRE gdal-bin tesseract-ocr \
        ...
        tesseract-ocr-ara tesseract-ocr-chi-sim tesseract-ocr-chi-sim-vert tesseract-ocr-chi-tra \
        tesseract-ocr-chi-tra-vert tesseract-ocr-fas tesseract-ocr-rus
